...
import { GetAbiResponseData, GetAbiResult, GetContractCreationResponseData } from "../models/block-explorer.types";

export class BasescanApi implements IBlockExplorerClient {
  // API
